...
4. In the "**Instructions**" section, add intructions on how the GPT should interact with Salesforce. You can copy and paste this tested sample. You  can copy and paste this tested sample: [sample-gpt-instructions-for-salesforce-integration](https://github.com/ai-data-innovators/ChatGPT-for-Salesforce/blob/main/sample-gpt-instructions-for-salesforce-integration.md)
